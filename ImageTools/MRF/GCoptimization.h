...
public:
    ...
    ///////////////////////////////////////////////////////////////////////////////////////
    /* Type for the total energy calculation. Change it in GraphCuts.h   */
    typedef GraphCuts::flowtype EnergyType;

    /* Type for the individual terms in the energy function.Change it in GraphCuts.h */
    typedef GraphCuts::captype EnergyTermType;
    ...
    /* This is the constructor for non-grid GraphCutss. Everything is the same as in the constructor  */
...
protected:
    ...
    /* This function is used to set the smoothness term, and it can be used only if                         */
     ...
     /* If GraphCuts is a grid, then using this  function only if the smooth costs are not spacially varying     */
    ...
    void setSmoothness(int smoothExp,CostVal smoothMax, CostVal lambda);
     ...
     /* This function is used to set the smoothness term, and it can be used only if                         */
     /* smoothSetup = PASS_AS_PARAMETER AND the GraphCuts is a grid                                              */
