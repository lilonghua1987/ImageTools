...
namespace mrf
{
	...
	*/
	...
	inline void GraphCuts::set_active(node *i)
	{
	    if (!i->next)
	    {
	...
	*/
	inline GraphCuts::node * GraphCuts::next_active()
	{
	    node *i;
	...
	void GraphCuts::augment(node *s_start, node *t_start, captype *cap_middle, captype *rev_cap_middle)
	{
	    node *i;
	    arc_forward *a;
	    captype bottleneck;
	...
	void GraphCuts::process_source_orphan(node *i)
	{
	    node *j;
	...
	void GraphCuts::process_sink_orphan(node *i)
	{
	    node *j;
	    arc_forward *a0_for, *a0_for_first, *a0_for_last;
	    arc_reverse *a0_rev, *a0_rev_first, *a0_rev_last;
	...
	GraphCuts::flowtype GraphCuts::maxflow()
	{
	...
	GraphCuts::termtype GraphCuts::what_segment(node_id i)
	{
